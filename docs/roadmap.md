...
| 9. Federated case library                     | ♻️ Superseded (2026-09-05) — case/episode pipeline removed; runbooks are the single KB signal (see [pueo-kb](https://github.com/AndysWorth/pueo-kb)) | — |
...
| Phase 20: Federated Case Library                   | ♻️ Superseded (2026-09-05) — case/episode pipeline removed; runbooks are the single KB signal (see [pueo-kb](https://github.com/AndysWorth/pueo-kb)) | 80–82   |
...
- **Session 4 (PR #671):** `ha_developer_docs_scraper.py` — config flows, entity model, WebSocket API, REST API; new `ha_developer_docs` ChromaDB collection
